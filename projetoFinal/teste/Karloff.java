...
// KARLOFF -> MAIN FUNC?
  static final public ArvoreKarloff Karloff() throws ParseException {Main main;
  ArrayList<Funcao> funcoes = new ArrayList();
    main = MainC();
    Func(funcoes);
    jj_consume_token(0);
{if ("" != null) return new ArvoreKarloff(main, funcoes);}
    throw new Error("Missing return statement in function");
}

// MAIN -> "void" "main" "(" ")" "{" VARDECL SEQCOMANDOS "}"
  static final public Main MainC() throws ParseException {ArrayList<Variavel> variaveis = new ArrayList();
...
{if ("" != null) return new Main(variaveis, comandos);}
    throw new Error("Missing return statement in function");
}

// VARDECL -> VARDECL "newVar" TIPO TOKEN_id ";" | vazio
  static final public void VarDecl(ArrayList<Variavel> variaveis) throws ParseException {Token t;
    label_1:
    while (true) {
...
// SEQCOMANDOS -> SEQCOMANDOS COMANDO | vazio
  static final public void SeqComandos(ArrayList<Comando> comandos) throws ParseException {Comando c;
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case CIF:
...
{if ("" != null) return c;}
    ...
    case CIF:{
      ...
      SeqComandos(comandos);
      jj_consume_token(FCHAVES);
{if ("" != null) return new If(teste, comandos);}
      break;
      }
    case CWHILE:{
      ...
      SeqComandos(comandos);
      jj_consume_token(FCHAVES);
{if ("" != null) return new While(teste, comandos);}
      break;
      }
    case CREP:{
      ...
      teste = Exp();
      jj_consume_token(FPAR);
{if ("" != null) return new Repeat(teste, comandos);}
      break;
      }
    case CRET:{
      jj_consume_token(CRET);
      exp = Exp();
{if ("" != null) return new Return(exp);}
      break;
      }
    case CPRINT:{
...
{if ("" != null) return new Print(exp);}
  ...
  static final public Comando ComID(Token t) throws ParseException {Comando c;
...
{if ("" != null) return c;}
    ...
    case APAR:{
      ...
      ListaExp(listaExp);
      jj_consume_token(FPAR);
{if ("" != null) return new FuncaoCallCom(new FuncaoCall(t.image, listaExp));}
      break;
      }
    default:
      jj_la1[4] = jj_gen;
  ...
  static final public Comando ComIDAtrib(Token t) throws ParseException {Expressao exp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case APAR:
    case BTRUE:
    case BFALSE:
    ...
    case NUM:{
      exp = Exp();
{if ("" != null) return new AtribExp(t.image, exp);}
      break;
      }
    case CREADINT:{
      ...
      jj_consume_token(APAR);
      jj_consume_token(FPAR);
{if ("" != null) return new AtribInput(t.image);}
      break;
      }
    default:
      jj_la1[5] = jj_gen;
...
// EXP -> "(" EXP OP EXP ")" | FATOR
  static final public Expressao Exp() throws ParseException {Expressao expEsq, expDir;
  Operador op;
  Fator f;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case APAR:{
      ...
      expDir = Exp();
      jj_consume_token(FPAR);
{if ("" != null) return new Operacao(op, expEsq, expDir);}
      break;
      }
    case BTRUE:
    case BFALSE:
    ...
    case NUM:{
      f = Fator();
{if ("" != null) return new FinalExpressao(f);}
      break;
      }
    default:
      jj_la1[6] = jj_gen;
...
// | TOKEN_numliteral |
// "true" | "false"
  static final public Fator Fator() throws ParseException {Token t;
  ArrayList<Expressao> listaExp = new ArrayList();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ID:{
      t = jj_consume_token(ID);
      ...
      case APAR:{
        ...
        ListaExp(listaExp);
        jj_consume_token(FPAR);
{if ("" != null) return new FuncaoCall(t.image, listaExp);}
        break;
        }
      default:
        jj_la1[7] = jj_gen;
...
{if ("" != null) return new Variavel(t.image);}
      break;
      }
    case NUM:{
...
// OP -> "+" | "-" | "*" | "/" | "&" | "|" | "<" | ">" | "=="
  static final public Operador Op() throws ParseException {Token t;
    t = jj_consume_token(OP);
{if ("" != null) return new Operador(t.image);}
    throw new Error("Missing return statement in function");
}

// LISTAEXP -> EXP | LISTAEXP "," EXP
  static final public void ListaExp(ArrayList<Expressao> listaExp) throws ParseException {Expressao exp;
    exp = Exp();
listaExp.add(exp);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case COMMA:{
  ...
  static final public void ListaExpL(ArrayList<Expressao> listaExp) throws ParseException {Expressao exp;
...
// | "func" TIPO TOKEN_id "(" LISTAARG? ")" "{" VARDECL SEQCOMANDOS "}"
  static final public void Func(ArrayList<Funcao> funcoes) throws ParseException {Tipo tipo_retorno;
  Token t;
...
// LISTAARG -> TIPO TOKEN_id | LISTAARG "," TIPO TOKEN_id
  static final public void ListaArg(ArrayList<Argumento> argumentos) throws ParseException {Token t;
  Tipo tipo;
    label_4:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
